...
export declare class MultipleGroupsResultsProcessor implements ResultsProcessor {
    private pathToScan;
    private orgPublicId;
    private iacOrgSettings;
    private options;
    constructor(pathToScan: string, orgPublicId: string, iacOrgSettings: IacOrgSettings, options: IaCTestFlags);
    processResults(resultsWithCustomSeverities: IacFileScanResult[], policy: Policy | undefined, tags: Tag[] | undefined, attributes: ProjectAttributes | undefined): Promise<{
        filteredIssues: FormattedResult[];
        ignoreCount: number;
    }>;
